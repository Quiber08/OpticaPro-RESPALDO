...
namespace OpticaPro
{
    public sealed partial class MainWindow : Window
    {
        ...
        // Bandera para evitar abrir múltiples diálogos a la vez
        ...
        public MainWindow()
        {
            ...
            // Iniciar vigilancia de seguridad y notificaciones
            InitializeSecurityWatchdog();

            // --- NUEVO: Iniciar sistema de actualizaciones ---
        ...
        // =========================================================================
        // MÉTODOS PARA NOTIFICACIONES (GLOBOS)
        // =========================================================================
        ...
        // =========================================================================
        // LÓGICA DE SEGURIDAD BLINDADA + NOTIFICACIONES AUTOMÁTICAS
        // =========================================================================
        private async void InitializeSecurityWatchdog()
        {
            ...
            // --- NUEVO: Revisar mensajes al iniciar ---
            await CheckUnreadMessages();
            // ------------------------------------------

            // 2. CAPA 2: Vigilancia en Tiempo Real
            ...
            // 3. CAPA 3: Timer Rápido (Cada 1 minuto)
        ...
        // =========================================================================
        // === SISTEMA DE ACTUALIZACIONES (AGREGADO) ===
        // =========================================================================
        private async void InitializeUpdateSystem()
        {
            // IMPORTANTE: Cambia esto con cada versión que publiques de tu software
            ...
            // 2. Revisión en tiempo real (mientras la app está abierta)
