...
namespace OpticaPro.Views
{
    public sealed partial class DashboardPage : Page
    {
        ...
        private void CalculateRealStats()
        {
            try
            {
                // 1. Obtener datos (Manejando listas nulas por si acaso)
            ...
            {
                // Si falla el cálculo, lo ignoramos silenciosamente para que la app abra igual
            }
        }
